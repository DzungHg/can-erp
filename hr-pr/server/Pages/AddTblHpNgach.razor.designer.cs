...
namespace CanErpHp.Pages
{
    public partial class AddTblHpNgachComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpNgach _tblhpngach;
        protected CanErpHp.Models.DbAtVdc2.TblHpNgach tblhpngach
        {
            get
            {
                return _tblhpngach;
        ...
        {
            tblhpngach = new CanErpHp.Models.DbAtVdc2.TblHpNgach();
        }
