...
namespace CanErpHp.Pages
{
    public partial class AddTblHpBacComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpBac _tblhpbac;
        protected CanErpHp.Models.DbAtVdc2.TblHpBac tblhpbac
        {
            get
            {
                return _tblhpbac;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            tblhpbac = new CanErpHp.Models.DbAtVdc2.TblHpBac();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpBac args)
        {
            try
            {
