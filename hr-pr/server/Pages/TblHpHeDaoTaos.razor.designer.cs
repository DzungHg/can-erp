...
namespace CanErpHp.Pages
{
    public partial class TblHpHeDaoTaosComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpHeDaoTao> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpHeDaoTao> _getTblHpHeDaoTaosResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpHeDaoTao> getTblHpHeDaoTaosResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpHeDaoTao args)
        {
