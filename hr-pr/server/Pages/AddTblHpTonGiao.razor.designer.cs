...
namespace CanErpHp.Pages
{
    public partial class AddTblHpTonGiaoComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpTonGiao _tblhptongiao;
        protected CanErpHp.Models.DbAtVdc2.TblHpTonGiao tblhptongiao
        {
            get
            {
        ...
        {
            tblhptongiao = new CanErpHp.Models.DbAtVdc2.TblHpTonGiao();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpTonGiao args)
        {
            try
            {
