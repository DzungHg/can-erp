...
namespace CanErpHp.Pages
{
    public partial class TblHpChiTietLuongsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong> _getTblHpChiTietLuongsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong> getTblHpChiTietLuongsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong args)
        {
