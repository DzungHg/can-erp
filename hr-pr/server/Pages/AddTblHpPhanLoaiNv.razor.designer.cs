...
namespace CanErpHp.Pages
{
    public partial class AddTblHpPhanLoaiNvComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv _tblhpphanloainv;
        protected CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv tblhpphanloainv
        {
            get
            {
        ...
        {
            tblhpphanloainv = new CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv();
        }
