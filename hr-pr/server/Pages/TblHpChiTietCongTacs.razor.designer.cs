...
namespace CanErpHp.Pages
{
    public partial class TblHpChiTietCongTacsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpChiTietCongTac> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietCongTac> _getTblHpChiTietCongTacsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietCongTac> getTblHpChiTietCongTacsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpChiTietCongTac args)
        {
