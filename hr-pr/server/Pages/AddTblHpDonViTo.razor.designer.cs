...
namespace CanErpHp.Pages
{
    public partial class AddTblHpDonViToComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpDonViTo _tblhpdonvito;
        protected CanErpHp.Models.DbAtVdc2.TblHpDonViTo tblhpdonvito
        {
            get
            {
        ...
        {
            tblhpdonvito = new CanErpHp.Models.DbAtVdc2.TblHpDonViTo();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpDonViTo args)
        {
            try
            {
