...
namespace CanErpHp.Pages
{
    public partial class AddTblGnDepartmentComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblGnDepartment _tblgndepartment;
        protected CanErpHp.Models.DbAtVdc2.TblGnDepartment tblgndepartment
        {
            get
            {
        ...
        {
            tblgndepartment = new CanErpHp.Models.DbAtVdc2.TblGnDepartment();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblGnDepartment args)
        {
            try
            {
