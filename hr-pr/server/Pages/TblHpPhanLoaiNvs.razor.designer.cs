...
namespace CanErpHp.Pages
{
    public partial class TblHpPhanLoaiNvsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv> _getTblHpPhanLoaiNvsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv> getTblHpPhanLoaiNvsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpPhanLoaiNv args)
        {
