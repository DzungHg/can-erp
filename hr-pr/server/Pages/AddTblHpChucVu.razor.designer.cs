...
namespace CanErpHp.Pages
{
    public partial class AddTblHpChucVuComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpChucVu _tblhpchucvu;
        protected CanErpHp.Models.DbAtVdc2.TblHpChucVu tblhpchucvu
        {
            get
            {
                return _tblhpchucvu;
        ...
        {
            tblhpchucvu = new CanErpHp.Models.DbAtVdc2.TblHpChucVu();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpChucVu args)
        {
            try
            {
