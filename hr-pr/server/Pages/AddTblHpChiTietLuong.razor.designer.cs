...
namespace CanErpHp.Pages
{
    public partial class AddTblHpChiTietLuongComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong _tblhpchitietluong;
        protected CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong tblhpchitietluong
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            tblhpchitietluong = new CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpChiTietLuong args)
        {
            try
            {
