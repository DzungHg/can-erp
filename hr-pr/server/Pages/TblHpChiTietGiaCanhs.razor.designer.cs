...
namespace CanErpHp.Pages
{
    public partial class TblHpChiTietGiaCanhsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpChiTietGiaCanh> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietGiaCanh> _getTblHpChiTietGiaCanhsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietGiaCanh> getTblHpChiTietGiaCanhsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpChiTietGiaCanh args)
        {
