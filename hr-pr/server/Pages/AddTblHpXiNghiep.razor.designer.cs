...
namespace CanErpHp.Pages
{
    public partial class AddTblHpXiNghiepComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpXiNghiep _tblhpxinghiep;
        protected CanErpHp.Models.DbAtVdc2.TblHpXiNghiep tblhpxinghiep
        {
            get
            {
        ...
        {
            tblhpxinghiep = new CanErpHp.Models.DbAtVdc2.TblHpXiNghiep();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpXiNghiep args)
        {
            try
            {
