...
namespace CanErpHp.Pages
{
    public partial class TblHpXiNghiepsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpXiNghiep> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpXiNghiep> _getTblHpXiNghiepsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpXiNghiep> getTblHpXiNghiepsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpXiNghiep args)
        {
