...
namespace CanErpHp.Pages
{
    public partial class AddTblHpTrinhDoChuyenMonComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon _tblhptrinhdochuyenmon;
        protected CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon tblhptrinhdochuyenmon
        {
            get
            {
        ...
        {
            tblhptrinhdochuyenmon = new CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon();
        }
