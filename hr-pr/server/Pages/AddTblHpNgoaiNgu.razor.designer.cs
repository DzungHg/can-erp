...
namespace CanErpHp.Pages
{
    public partial class AddTblHpNgoaiNguComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu _tblhpngoaingu;
        protected CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu tblhpngoaingu
        {
            get
            {
        ...
        {
            tblhpngoaingu = new CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu();
        }
