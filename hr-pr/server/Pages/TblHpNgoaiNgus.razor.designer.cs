...
namespace CanErpHp.Pages
{
    public partial class TblHpNgoaiNgusComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu> _getTblHpNgoaiNgusResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu> getTblHpNgoaiNgusResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpNgoaiNgu args)
        {
