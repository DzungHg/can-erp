...
namespace CanErpHp.Pages
{
    public partial class AddTblHpNganhComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpNganh _tblhpnganh;
        protected CanErpHp.Models.DbAtVdc2.TblHpNganh tblhpnganh
        {
            get
            {
                return _tblhpnganh;
        ...
        {
            tblhpnganh = new CanErpHp.Models.DbAtVdc2.TblHpNganh();
        }

        protected async System.Threading.Tasks.Task Form0Submit(CanErpHp.Models.DbAtVdc2.TblHpNganh args)
        {
            try
            {
