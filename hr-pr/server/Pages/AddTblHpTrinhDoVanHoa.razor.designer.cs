...
namespace CanErpHp.Pages
{
    public partial class AddTblHpTrinhDoVanHoaComponent : ComponentBase
    {
        ...
        CanErpHp.Models.DbAtVdc2.TblHpTrinhDoVanHoa _tblhptrinhdovanhoa;
        protected CanErpHp.Models.DbAtVdc2.TblHpTrinhDoVanHoa tblhptrinhdovanhoa
        {
            get
            {
        ...
        {
            tblhptrinhdovanhoa = new CanErpHp.Models.DbAtVdc2.TblHpTrinhDoVanHoa();
        }
