...
namespace CanErpHp.Pages
{
    public partial class TblHpNganhsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpNganh> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpNganh> _getTblHpNganhsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpNganh> getTblHpNganhsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpNganh args)
        {
