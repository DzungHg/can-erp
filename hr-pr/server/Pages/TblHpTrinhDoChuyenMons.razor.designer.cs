...
namespace CanErpHp.Pages
{
    public partial class TblHpTrinhDoChuyenMonsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon> _getTblHpTrinhDoChuyenMonsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon> getTblHpTrinhDoChuyenMonsResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(CanErpHp.Models.DbAtVdc2.TblHpTrinhDoChuyenMon args)
        {
