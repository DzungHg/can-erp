...
namespace CanErpHp.Pages
{
    public partial class TblHpChiTietChuyenMonsComponent : ComponentBase
    {
        ...
        protected RadzenGrid<CanErpHp.Models.DbAtVdc2.TblHpChiTietChuyenMon> grid0;

        IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietChuyenMon> _getTblHpChiTietChuyenMonsResult;
        protected IEnumerable<CanErpHp.Models.DbAtVdc2.TblHpChiTietChuyenMon> getTblHpChiTietChuyenMonsResult
        {
            get
            {
